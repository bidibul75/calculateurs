...
console.log(
  ...
  index_min,
  "combinaison : ",
  combinaisons[index_min]
);

// combinaisons.forEach((itemCombinaisons, index) => {
//   sousReseaux = sousReseaux.filter((item) => item !== itemCombinaisons);
// });
// console.log("combinaisons2 : ", sousReseaux);
