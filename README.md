...
Je m'appelle Walter Bianchi. Je viens d'obtenir un Bachelor Développeur de Solution Numériques Sécurisées à la Coding Factory à Paris (France).
Je suis à la recherche d'une embauche ou d'une alternance en master dans le domaine du développement web ou logiciel en Ile-de-France. [Mon Linkedin.](https://ww.linkedin.com/in/walter-bianchi-515b6a20)

## Contribuer

Il s'agit d'un projet personnel et individuel conçu comme un exercice et ayant pour but la mise en valeur de mon savoir-faire. Je ne souhaite donc pas de contribution externe à ce projet et je ne validerai pas les éventuelles pull requests. Je vous remercie de votre compréhension.
