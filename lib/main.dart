...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  void generateHistory() {
    _history = "${_num1.toString().cleanPointZero()} ";
    print("opé: $_operation");
    if (_operation.isEmpty) return;
    _history += _operation;
    //ERREUR A CE MOMENT
    print("generate : $_num2");
    if (_num2 == 0) return;
    _history += _num2.toString().cleanPointZero();
    _history += _output.isEmpty ? "" : "= ${_output.cleanPointZero()}";
  }
